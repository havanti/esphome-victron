...
#define BLE_DATA_STORAGE(name, type) \
  ...
  BLE_DATA_STORAGE(val2_, uint16_t)
  BLE_DATA_STORAGE(val3_, uint16_t)
  BLE_DATA_STORAGE(val4_, int16_t)
  BLE_DATA_STORAGE(remaining_time_, uint16_t)
...
#define BLE_DATA_RESET(name, type) \
  ...
  void reset_state() {
    ...
    BLE_DATA_RESET(state_of_charge_, uint16_t)
    ...
    BLE_DATA_RESET(val2_, uint16_t)
    BLE_DATA_RESET(val3_, uint16_t)
    BLE_DATA_RESET(val4_, int16_t)
    BLE_DATA_RESET(remaining_time_, uint16_t)
  };
