...
// 0.1 A, 0 .. 6553.4 A
enum vic_16bit_0_1_positive : uint16_t;
...
// 0.01 V, 0 .. 327.66 V
enum vic_15bit_0_01_positive : uint16_t;

// 0.01 V, 0 .. 163.83 V
enum vic_14bit_0_01_positive : uint16_t;

// 0.01 V, 0 .. 81.90 V
enum vic_13bit_0_01_positive : uint16_t;

// 0.01 V, 0 .. 40.94 V
enum vic_12bit_0_01_positive : uint16_t;

// 0.1 A, 0 .. 204.6 A
enum vic_11bit_0_1_positive : uint16_t;
...
// 0.1 A, 0 .. 51.0 A
enum vic_9bit_0_1_positive : uint16_t;
...
enum vic_cell_7bit_0_01 : uint16_t;

// 1 %, 0 .. 126 %
enum vic_7bit_1 : uint16_t;

// 1 °C, -40 .. 86 °C - Temperature = Record value - 40
enum vic_temperature_7bit : uint16_t;